        ...
        <div class="flex w-[100%] pb-4 mx-auto">
            <div class="mx-auto pb-24">
                <div class="bg-white">
                    <NuxtLink
                        to="/create"
                        class="bg-[#50d71e] hover:bg-[#79cb5b] text-white rounded-full px-4 py-2"
                    >Them san Pham
                    </NuxtLink>
                        ...
                        <table class="w-[750px]">
                            ...
                            <tbody>
                                <tr v-for="(product, index) in products" :key="index">
                                    ...
                                    <td class="text-center flex justify-around items-center cursor-pointer">
                                        <NuxtLink
                                            :to="`/edit/${product.id}`"
...
<script setup>
    ...
    const deleteProduct = async (id) => {
        const res = confirm(`Có không giữ mất đừng tìm`);
        try {
            if (res) {
